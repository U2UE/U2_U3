...
- 상태줄 `.gp-st`: 단계 Segmented · `gig` 진행바 · 「완료 **4/14** · 진행 2 · 자료 대기 1」 · 보기 전환(할 일 | 금액).
- 금액 보기: `.gm-sum` 요약(기준 · 변경 · 현재 · 실수령(3.3% 원천징수) · 입금 · 남은 돈), 변경은 `accent-ink`(+)/`bad`(−), 남은 돈 `gig`. 아래 `.gcols` 2칸(금액 변경 / 입금)에 MoneyRow.
